      ...
      e: for (var Q = 0, G = E.length, er = G >>> 1; Q < er; ) {
        ...
        if (0 > l(Cl, z))
          yt < G && 0 > l(tr, Cl)
            ? ((E[Q] = tr), (E[yt] = z), (Q = yt))
            : ((E[Q] = Cl), (E[gt] = z), (Q = gt));
        else if (yt < G && 0 > l(tr, z)) (E[Q] = tr), (E[yt] = z), (Q = yt);
        else break e;
      }
    }
    return P;
  ...
  function S(E, P) {
    ...
    try {
      ...
      if (h !== null) var er = !0;
        ...
        var gt = n(c);
        gt !== null && xl(g, gt.startTime - P), (er = !1);
      }
      return er;
    } finally {
      (h = null), (m = z), (w = !1);
...
function ks() {
  if (Zt) {
    var e = Zt,
      t = Kt;
    if (((Kt = Zt = null), Ko(e), t)) for (e = 0; e < t.length; e++) Ko(t[e]);
  }
}
function Ss(e, t) {
  return e(t);
...
function Y0(e, t, n, r, l, i, o, u, s) {
  (En = !1), (Fr = null), W0.apply(Q0, arguments);
}
...
function js(e) {
  return (e = K0(e)), e !== null ? Ls(e) : null;
}
function Ls(e) {
...
var $r = null;
function pi(e, t, n, r) {
  if ((($r = null), (e = Ji(r)), (e = Ct(e)), e !== null))
...
function uu() {
  _n && (_n.detachEvent("onpropertychange", Ys), ($n = _n = null));
}
function Ys(e) {
  if (e.propertyName === "value" && ol($n)) {
    var t = [];
    Ws(t, $n, e, Ji(e)), Ns($2, t);
  }
}
function B2(e, t, n) {
  e === "focusin"
    ? (uu(), (_n = t), ($n = n), _n.attachEvent("onpropertychange", Ys))
    : e === "focusout" && uu();
}
function V2(e) {
...
for (var Rl = 0; Rl < fu.length; Rl++) {
  var Ol = fu[Rl],
    Z2 = Ol.toLowerCase(),
    K2 = Ol[0].toUpperCase() + Ol.slice(1);
  mt(Z2, "on" + K2);
}
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              g !== null &&
              ((d = g),
              f !== null && ((g = Rn(a, f)), g != null && C.push(Vn(a, g, d)))),
            $)
          )
            break;
          a = a.return;
...
function so(e) {
  for (; e === Ar; )
    (Ar = Vt[--Ht]), (Vt[Ht] = null), (Wr = Vt[--Ht]), (Vt[Ht] = null);
  for (; e === jt; )
    (jt = Ce[--ke]),
      (Ce[ke] = null),
      (Ae = Ce[--ke]),
...
function Ne(e) {
  ...
  if (co !== e)
    if (((e = { context: e, memoizedValue: t, next: null }), At === null)) {
      ...
      (At = e), (Yr.dependencies = { lanes: 0, firstContext: e });
    } else At = At.next = e;
  return t;
}
var kt = null;
...
function vo(e, t) {
  switch ((O(Wn, t), O(An, e), O(Ue, bn), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function xo(e, t, n, r, l, i) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (_r.current = e === null || e.memoizedState === null ? ac : cc),
    (e = n(r, l)),
    Ln)
  ) {
    i = 0;
  ...
  ac = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        jr(4194308, 4, Na.bind(null, t, e), n)
      );
    },
...
function Fu(e, t, n, r, l) {
  ...
  if ((Gt(t, l), t.stateNode === null))
    Lr(e, t), fa(t, n, r), _i(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
...
function mc(e, t, n, r, l, i, o) {
  ...
  if (((u = (o & e.childLanes) !== 0), fe || u)) {
    ...
    return zo(), (r = Wl(Error(y(421)))), hr(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function vc(e, t, n) {
  ...
  switch ((so(t), t.tag)) {
    ...
    case 4:
      return (
        nn(), Mi(e, t), e === null && Bn(t.stateNode.containerInfo), re(t), null
      );
    case 10:
...
function Qa(e) {
  ...
  t !== null && ((e.alternate = null), Qa(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ie], delete t[Hn], delete t[xi], delete t[tc], delete t[nc])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ga(e, t) {
  if (((Pr = -1), (zr = 0), F & 6)) throw Error(y(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = el(e, r);
    ...
    fo(),
      (Jr.current = i),
      (F = l),
      Z !== null ? (t = 0) : ((q = null), (ee = 0), (t = X));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((l = fi(e)), l !== 0 && ((r = l), (t = Ui(e, l)))), t === 1)
    )
      throw ((n = Kn), Et(e, 0), tt(e, r), me(e, Y()), n);
    if (t === 6) tt(e, r);
    else {
      if (
...
function Hu(e) {
  ...
  if (n === 1) throw ((n = Kn), Et(e, 0), tt(e, t), me(e, Y()), n);
...
function Et(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), q2(n)), Z !== null))
...
function el(e, t) {
  ...
  while (!0);
  if ((fo(), (F = n), (Jr.current = r), Z !== null)) throw Error(y(261));
  ...
  if (rt !== null) {
    ...
    try {
      if (((Ee.transition = null), (R = 16 > e ? 16 : e), rt === null))
        ...
        if (((e = rt), (rt = null), (br = 0), F & 6)) throw Error(y(331));
        var l = F;
...
function t0(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var n = ue();
  (e = Ke(e, t)), e !== null && (Gn(e, t, n), me(e, n));
}
function jc(e) {
  var t = e.memoizedState,
    n = 0;
...
n0 = function (e, t, n) {
  ...
  else (fe = !1), U && t.flags & 1048576 && ia(t, Wr, t.index);
...
Ss = Lo;
Es = zt;
var Oc = { usingClientEntryPoint: !1, Events: [qn, Ut, sl, Cs, ks, Lo] },
  yn = {
...
var Ic = is.exports,
  Yu = Ic;
(Kl.createRoot = Yu.createRoot), (Kl.hydrateRoot = Yu.hydrateRoot);
const L = {
  ...
  Jc = "/assets/google-WRVvRcZb.svg",
  qc = "/assets/apple-CMTicvIO.svg",
  bc =
        ...
        p.jsx("ul", {
          ...
          children: wr.map((n, r) =>
            p.jsx(
              "li",
              {
                className: `font-poppins font-normal cursor-pointer text-[16px] ${r === wr.length - 1 ? "mr-0" : "mr-10"} text-white `,
                children: p.jsx("a", { href: `#${n.id}`, children: n.title }),
              },
              n.id,
            ),
          ),
          ...
          children: p.jsx("ul", {
            ...
            children: wr.map((n, r) =>
              p.jsx(
                "li",
                {
                  className: `font-poppins font-normal cursor-pointer text-[16px] ${r === wr.length - 1 ? "mr-0" : "mb-4"} text-white `,
                  children: p.jsx("a", { href: `#${n.id}`, children: n.title }),
                },
                n.id,
              ),
  ...
  p1 = () =>
    p.jsxs("section", {
      ...
      children: [
        ...
        p.jsx("div", {
          className:
            "absolute z-[3] -left-1/2 top-0 w-1/2 h-1/2 rounded-full white_gradient",
        }),
        p.jsx("div", {
          className:
            "absolute z-[0] -left-1/2 bottom-0 w-1/2 h-1/2 rounded-full pink_gradient",
        }),
        p.jsxs("div", {
          ...
          children: [
            ...
            p.jsx("p", {
              ...
              children:
                "Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis optio reprehenderit sequi porro, impedit ex quam velit aut, molestias eligendi",
            }),
            p.jsxs("div", {
  ...
  Do = ({ styles: e }) =>
    p.jsx("button", {
      type: "button",
      className: `py-4 px-6 bg-blue-gradient font-poppins font-medium text-[18px] text-primary outline-none rounded-[10px] ${e}`,
        ...
        p.jsxs("div", {
          ...
          children: [
            ...
            p.jsxs("p", {
              className: `${L.paragraph} max-w-[470px] mt-5`,
              children: [
                "Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque inventore recusandae quidem iure consequuntur ducimus quos commodi dicta? Minima vero incidunt aspernatur quidem",
                " ",
              ],
            }),
  ...
  h1 = ({ icon: e, title: t, content: n, index: r }) =>
    p.jsxs("div", {
      className: `flex flex-row p-6 rounded-[20px] ${r !== a0.length - 1 ? "mb-6" : "mb-0"} feature-card`,
      children: [
        p.jsx("div", {
        ...
        p.jsxs("div", {
          ...
          children: [
            ...
            p.jsx("p", {
              className: `${L.paragraph} max-w-[470px] mt-5`,
              children:
                "With the right credit card, you can improve your finacial life by building credit, earning rewards and saving money. BUt with hundreds of credit cards on the market.",
            }),
            p.jsx(Do, { styles: "mt-10" }),
          ],
        }),
  ...
  g1 = () =>
    p.jsxs("section", {
      ...
      children: [
        p.jsx("div", {
          className: `${L.flexCenter} flex flex-wrap w-full`,
          children: f1.map((e) =>
            p.jsx(
              "div",
              {
                className: `flex-1 ${L.flexCenter} sm:min-w-[192px] min-w-[120px]`,
                children: p.jsx("img", {
                  src: e.logo,
                  alt: "client",
          ...
          children: [
            p.jsxs("div", {
              ...
              children: [
                ...
                p.jsx("p", {
                  className: `${L.paragraph} mt-4 max-w-[310px]`,
                  children:
                      ...
                      p.jsx("ul", {
                        ...
                        children: e.links.map((t, n) =>
                          p.jsx(
                            "li",
                            {
                              className: `font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary cursor-pointer ${n !== e.links.length - 1 ? "mb-4" : "mb-0"}`,
                              children: t.name,
                            },
                            t.name,
                          ),
        ...
        p.jsxs("div", {
          ...
          children: [
            p.jsx("p", {
              ...
              children: "2024 HooBank. All Rights Reserved",
            }),
            p.jsx("div", {
              ...
              children: Zu.map((e, t) =>
                p.jsx(
                  "img",
                  {
                    src: e.icon,
                    alt: e.id,
                    className: `w-[21px] h-[221px] object-contain cursor-pointer ${t !== Zu.length - 1 ? "mr-6" : "mr-0"}`,
                  },
                  e.id,
                ),
              ),
          ...
          children: [
            ...
            p.jsxs("div", {
              ...
              children: [
                ...
                p.jsx("p", {
                  className: `flex flex-col ml-4">\r
  ...
  k1 = () =>
    p.jsxs("section", {
      ...
      children: [
        p.jsx("div", {
          className:
            "absolute z-[0] w-[60%] -right-[50%] rounded-full blue__gradient",
        }),
        p.jsxs("div", {
          className:
            "w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 realtive z-[1]",
          children: [
            p.jsxs("h1", {
              className: L.heading2,
              children: [
        ...
        p.jsx("div", {
          ...
          children: s1.map((e, t) => p.jsx(C1, { ...e }, e.id)),
        }),
      ],
    }),
  Ku = () =>
  ...
  E1 = () =>
    p.jsxs("div", {
      ...
      children: [
        ...
        p.jsx("div", {
          className: `bg-primary ${L} ${L.flexStart}`,
          children: p.jsx("div", {
            className: `${L.boxWidth}`,
            children: p.jsx(S1, {}),
          }),
        ...
        p.jsx("div", {
          className: `bg-primary ${L.paddingX} ${L.flexStart}`,
          children: p.jsxs("div", {
            className: `${L.boxWidth}`,
            children: [
              p.jsx(w1, {}),
